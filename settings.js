...
SESSION_ID: process.env.SESSION_ID === defined ? 'VAJIRA-MD=TJEEBBzS#qTF3AAzQQMXTmGswn_F0upTzY3S6qVjzoRpj35kh9iQ' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === defined ? '' : process.env.OWNER_NUMBER,   
